...
@section('title',$dataviewCategorycurrent[0]->name)
...
@section('metatitle',$dataviewCategorycurrent[0]->name)
@section('content')
...
<?php }else{ ?>
<!-- <div class="parallax z1" style="background-image: url('{{ asset('img/MS-Loire-Princesse-Loire-profil03-CroisiEurope©CroisiEurope.jpg') }}');height: 53vh;background-attachment: unset;"> -->
