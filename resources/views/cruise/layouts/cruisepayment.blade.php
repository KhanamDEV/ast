...
<div class="nav-on-top clearfix" style="background-color: #22374e;margin-right: auto; margin-left: auto;">
  ...
  <ul class="nav float-right fix-nav-top-1 pr-5" style="position: relative;">
    
   <li class="nav-item pr-4">
    <a class="nav-link text-white" href="{{ url('/contactform') }}"> <i class="far fa-envelope" style="font-size: .8rem;position: relative;top: 1px;"></i> <span style="font-weight: 600">Contact Us</span></a>
  </li>
...
<!-- <li class="nav-item dropdown" style="position: unset;"> -->
            <a  class="nav-link text-white" style="font-weight: 600" id="navbarDropdown1li" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#" >Login</a>
...
<div class="cus-dr-t-mn p-0 dropdown-menu dropdown-menu1" aria-labelledby="navbarDropdown1li">
  ...
  <li class="nav-item pr-4">
    <a class="nav-link text-white" style="font-weight: 600" href="#">ENG | AUD</a>
  </li>
  <li class="nav-item text-right d-none d-sm-block pr-4"><img style="margin-top: 0.75rem" src="{{url('img/flag.png')}}" alt=""></li>
  <li class="nav-item pr-4">        <a class="ct-cart-move" href="{{ url('/cart') }}"><img src="{{ asset('img/imgcart.png') }}" style="width: 30px;height: 30px;padding-top: 5px;"><span class="ct-cart-movesp badge maunentwt chutwt"><?php echo Cart::count(); ?></span></a></li>
...
<div class="modal fade fix-showmb-scruise" id="menusearchcruise" tabindex="-1" role="dialog" aria-labelledby="modalsearchcruise" aria-hidden="true">
 ...
 <form action="/search" method="GET">
  ...
  <ul class="first-nav">
                    <li>
                      <a href="#" data-toggle="modal" data-target="#menusearchcruise">CRUISE SEARCH</a>
                    </li>
                    <li>
                        <a href="{{ url('/europe-cruises') }}">EUROPE CRUISES</a>
                        <ul>
                            <li><a href="{{ url('/m',['16','Northern-Europe']) }}">Northern Europe</a></li>
                            <li><a href="{{ url('/m',['17','Southern-Europe']) }}">Southern Europe</a></li>
                            <li><a href="{{ url('/m',['18','Central-Europe']) }}">Central Europe</a></li>
                            <li><a href="{{ url('/m',['19','French-Rivers-and-Canals']) }}">French Rivers and Canals</a></li>
                            <li><a href="{{ url('/l',['20','Multi-River-Cruises']) }}">Multi River Cruises</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ url('/worldwide-cruises') }}">WORLDWIDE CRUISES</a>
                        <ul>
                            <li><a href="{{ url('/l',['25','Mekong-River-Vietnam-and-Cambodia']) }}">Mekong Delta</a></li>
                            <li><a href="{{ url('/l',['65','Southern-Africa-Cruises' ]) }}">Southern Africa</a></li>
                            <li><a href="{{ url('/l',['23','Cruise-the-St-Lawrence-in-Canada']) }}">North America (Canada)</a></li>
                            <li><a href="{{ url('/l',['24','Volga-River-Russia']) }}">Russia</a></li>
                            <li><a href="{{ url('/l',['15','Coastal-Cruises']) }}">Coastal Cruises</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ url('/themed-cruises') }}">THEMED CRUISES</a>
                        <ul>
                            <li><a href="{{ url('/l',['203','Family-Club']) }}">Family Club</a></li>
                            <li><a href="{{ url('/l',['201','Hiking-Cruises']) }}">Hiking Cruises</a></li>
                            <li><a href="{{ url('/l',['201','Biking-Cruises']) }}">Biking Cruises</a></li>
                            <li><a href="{{ url('/l',['204','gastronomy-and-wine-cruises']) }}">Gastronomy and Wine Cruises</a></li>
                            <li><a href="{{ url('/l',['21','Christmas-and-New-Year-Cruises']) }}">Christmas and New Year</a></li>
                        </ul>
                    </li>
  </ul>
            ...
            <ul class="bottom-nav">
              <li class="github">
                <a class="nav-link" href="https://www.facebook.com/worldwiderivercruises" target="_blank"><i class="fab fa-facebook-f mauvang font-weight-bold" style="font-size: 1.4rem;"></i></a>
              </li>
              <li class="email">
                 <a class="nav-link" href="https://www.instagram.com/worldwiderivercruises" target="_blank"><i class="fab fa-instagram mauvang font-weight-bold"  style="font-size: 1.4rem;"></i></a>
              </li>
              <li class="ko-fi">
                <a class="nav-link" href="https://www.twitter.com/WRiverCruise" target="_blank"><i class="fab fa-twitter mauvang font-weight-bold"  style="font-size: 1.4rem;"></i></a>
                </a>
              </li>
            </ul>
...
<script>
  (function($) {
          ...
          var defaultData = {
            maxWidth: false,
            customToggle: $toggle,
            navTitle: '<span style="color:rgba(213, 176, 75, 1);font-weight:600;">Worldwide River Cruises<span>',
            levelTitles: false,
            insertBack:true,
            insertClose: true,
            closeLevels: false,
