...
@section('title','Contact Form - Asia School Tours')
@section('description', 'Asia School Tours Contact Form')
@section('metatitle','Contact Form - Asia School Tours')
@section('content')
...
@endif
      ...
      <form class="form-horizontal" role="form" method="POST" action="contactstore">
                        {{ csrf_field() }}
...
<div class="row p-0 mt-4">
  <div class="col-md-2 p-0">
      <button class="btn-block border-0 nen-maucam p-0 font-weight-b500" id="btn_submit" type="submit" style="border-radius:5px;height: 40px;color: #fff;">SEND</button>
  </div>
</div>        
  </div>
...
<script>
         grecaptcha.ready(function() {
             grecaptcha.execute('{{ config('services.recaptcha.sitekey') }}', {action: 'contactstore'}).then(function(token) {
                if (token) {
