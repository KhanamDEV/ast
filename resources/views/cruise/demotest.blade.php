...
<section>
<div class="parallax-window" data-parallax="scroll" data-speed="0.5" data-image-src="img/slide/2200x1030/Slovaquie-Danube-Bratislava-rive-bateau_CroisiEurope.jpg">
    <div class="first-div" style="height: 80vh">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/europe-cruises') }}">
...
<section>
<div class="parallax-window" data-parallax="scroll" data-speed="0.5" data-image-src="img/MS-Loire-Princesse-Loire-profil05-CroisiEurope©CroisiEurope.jpg">
      <div class="first-div" style="height: 80vh">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/worldwide-cruises') }}">
      <p class="m-0" data-aos="zoom-in" data-aos-anchor-placement="top-bottom">Worldwide Cruises</p>     
    </a>
    </div>
  </div>
</div>
...
<section>
<div class="parallax-window" data-parallax="scroll" data-speed="0.5" data-image-src="img/slide/2200x1030/Suisse-Rhin-Bale-chutes-du-Rhin01©CroisiEurope.jpg">
      <div class="first-div" style="height: 80vh">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/themed-cruises') }}">
      <p class="m-0" data-aos="zoom-in" data-aos-anchor-placement="top-bottom">&nbsp&nbsp THEMED CRUISES &nbsp&nbsp</p>     
    </a>
    </div>
  </div>
</div>
...
<div class="parallax z1" style="background-image: url('img/slide/2200x1030/Slovaquie-Danube-Bratislava-rive-bateau_CroisiEurope.jpg');height: 80vh;">
  <div class="first-div" style="height: 80vh">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/europe-cruises') }}">
      <p class="m-0" data-aos="zoom-in" data-aos-anchor-placement="top-bottom">&nbsp &nbsp Europe Cruises &nbsp &nbsp</p>     
...
<div class="parallax z2" style="background-image: url('img/MS-Loire-Princesse-Loire-profil05-CroisiEurope©CroisiEurope.jpg');height: 80vh;">
	  <div class="first-div" style="height: 80vh">
      <a href="">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/worldwide-cruises') }}">
...
<div class="parallax z3" style="background-image: url('img/slide/2200x1030/Suisse-Rhin-Bale-chutes-du-Rhin01©CroisiEurope.jpg');height: 80vh;">
	  <div class="first-div" style="height: 80vh">
      <a href="">
    <div class="first-inner-div btn-8">
      <a href="{{ url('/themed-cruises') }}">
	...
	<div class="container-fluid text-white">
      ...
      <div class="col-md-4">
        <div class="warpper-ct text-center p-3">
          ...
          <img src="{{ asset('img/icon-homepage/subscribe-for-newsletter.png') }}" class="img-fluid" style="width: 14%"></a>
        </div>
      </div>
          ...
          <img src="{{ asset('img/icon-homepage/ask-for-brochure.png') }}" class="img-fluid" style="width: 15%"></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="warpper-ct text-center p-3">
          ...
          <img src="{{ asset('img/icon-homepage/contact-form.png') }}" class="img-fluid" style="width: 11%"></a>
  				</div>
			</div>
		</div>
		</div>
...
<!-- <section class="hohohu1">
	<div class="parallax z4" style="background-image: url('img/slide/MS-Vasco-Gama-Douro-profil02-CroisiEurope©Alain Bron.jpg');height: 53vh;">
	</div>
</section> -->

<section>
  <div style="min-height: 53vh !important;" class="parallax-window" data-android-fix="true" data-parallax="scroll" data-speed="0.5" data-image-src="img/slide/MS-Vasco-Gama-Douro.jpg"></div>
</section>
...
@section('jsmain')
<script>
  // $('.parallax-window').parallax({imageSrc: 'img/slide/2200x1030/Slovaquie-Danube-Bratislava-rive-bateau_CroisiEurope.jpg'});
</script>
@endsection
@endsection