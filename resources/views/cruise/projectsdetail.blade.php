...
@section('title',$dataviewcategory->name .' - Asia School Tours')
@section('description', htmlspecialchars($dataviewcategory->description))
@section('metatitle',$dataviewcategory->name .' - Asia School Tours')
@section('content')
<?php 
  $countries = array(
  'af' => 'Afghanistan',
...
<img src="{{ asset('https://b2b.tweetworldtravel.com.au/images/imagecover/l_183593_1.jpg') }}" class="img-fluid w-100 height-53vh" alt="Project Types" style="position: relative;">
    <div class="container">
      <div style="position: absolute;bottom: 0;margin-bottom: 30px;">
        <h1 class="text-white mb-4">Project Types</h1>
      </div>
    </div>
</section>
...
<ul class="nav nav-pills" style="font-size: 1rem">
  <li class="nav-item pr-1">
    <a class="nav-link" href="{{ url('/projects') }}">All project types</a>
  </li>
  <li class="nav-item pr-1">
  ...
  <li class="nav-item pr-1">
    <a class="nav-link {{ ($dataviewcategory->name == 'Volunteering')?'active':' '}}" href="{{ url('/projects',['Volunteering-Activities']) }}">Volunteering</a>
  </li>
  <li class="nav-item">
...
<div class="container">
  <div class="title-hd-sc pb-5">
    ...
    switch ($dataviewcategory->name) {
     ...
     ?>
    <h4 style="font-weight: 400;line-height: 1;letter-spacing: -0.5px;font-size: 16px">{!! $dataviewcategory->description !!}</h4>
   <!-- <h4 style="font-weight: 400;line-height: 1;letter-spacing: -0.5px;font-size: 16px">A wide range of community projects are available for students to participate, including but not limiting to the below:</h4> -->
  </div>
  <div class="row">
   <?php 
   $key_country = '';
    ...
    <div class="col-md-6 col-lg-4">
       <?php 
         ...
         <a data-target="#onrequest" data-toggle="modal" href="#onrequest" data-title="{{$valuedataview->title}}" class="booking_cruise_request">
   ...
   <img class="card-img-top"  src="https://b2b.tweetworldtravel.com.au/images/<?php echo $valuedataview->image ?>" alt="<?php echo $valuedataview->title ?>" />
                    <?php } ?>
                          ...
                          <a data-target="#onrequest" data-toggle="modal" href="#onrequest" data-title="{{$valuedataview->title}}" class="booking_cruise_request enquirebook btn btn-block">Enquire this Project</a>
    </a>
  ...
  $content_show_text = '';
    switch ($data_view_name) {
      ...
      default:
        ...
        <div class="py-2 div_content_flag1" >
          <div class="article">
            <div class="card-text fix-p text short">
            	{!!$valuedataview->body!!}
            </div>
         ...
         {{-- <a data-target="#onrequest" data-toggle="modal" href="#onrequest" data-title="{{$valuedataview->title}}" class="booking_cruise_request under-a-st">Enquire This Project</a> --}}
    </div>
  <?php } ?>
