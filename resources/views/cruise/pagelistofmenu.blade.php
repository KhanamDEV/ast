...
@section('title',isset($dataviewCategorycurrent[0]->name)?$dataviewCategorycurrent[0]->name:'Search - Worldwide River Cruises')
...
@section('metatitle',isset($dataviewCategorycurrent[0]->name)?$dataviewCategorycurrent[0]->name:'Search - Worldwide River Cruises')
@section('content')
...
<!-- <div class="parallax z1" style="background-image: url('{{ asset('img/slide/Slovaquie-Danube-Bratislava-rive-bateau_CroisiEurope.jpg') }}');height: 53vh;background-attachment: unset;"> -->
    <div class="parallax-window-53" data-parallax="scroll" data-speed="0.5" data-image-src="{{ asset('img/slide/Slovaquie-Danube-Bratislava-rive-bateau_CroisiEurope.jpg') }}">
<?php } ?>


  <div class="first-div" style="height: 53vh">
    <a href="">
    <div class="first-inner-div fix-pl-tn btn-8 mobile-hide">
      <?php 
...
<?php
 ...
 ?>
                ...
                <div class="row">
                  @foreach ($dataviewdetails->data as $itemcruise)
                  <?php 
                  //print_r($itemcruise);
                   ?>
                      ...
                      <a href="{{ url('/posts',[$itemcruise->tripcode,$data_name]) }}">
                        <div class="post-module">
                          ...
                          <div class="thumbnail">
                            ...
                            <?php }else{?>
                               <?php 
                if(!empty($itemcruise->imageup)){
                    $data_image_slite = json_decode($itemcruise->imageup,TRUE);
                 ?>
   <img src="https://b2b.tweetworldtravel.com.au/images/add/<?php echo str_replace('cruise','',str_replace('undefined','',end($data_image_slite)))?>" />
   ...
   <img src="https://b2b.tweetworldtravel.com.au/images/<?php echo $itemcruise->image ?>" alt="<?php echo $itemcruise->title ?>" />
                    <?php } ?>
                          ...
                          <div class="post-content">
                            <div class="category">
                              ...
                              <h1 class="title"><?php echo ucwords(strtolower($itemcruise->title));  ?></h1>
        ...
        <div class="description"><p style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;  ">
          ...
          <?php 
           echo substr(strip_tags($itemcruise->body),0,100); 
           ?>
        </p></div>
                              <!-- <div class="description" style="text-overflow: ellipsis;overflow: hidden;white-space: nowrap;"><?php echo substr(strip_tags($itemcruise->shortdescription),0,100);  ?></div> -->
                              <!-- <p class="description">Some text about the cruises. Super slim and comfy lorem ipsum lorem jeansum. Lorem jeamsun denim lorem jeansum.</p> -->
  ...
  <p class="float-right">Duration <span class="text-secondary"><?php echo $itemcruise->duration + 1 ?> days <i class="far fa-clock fa-fw" style="font-size: .8rem;"></i></span></p>
</div>
