...
@section('metaimage', $image_codever)
...
#tab-Additional .card-header {
    background-color: #f1f1f1 !important;
    color: #000;
    padding: 2px;
  }
  #tab-Additional .card-header .btn-link{
      color: #000; 
  }
  #tab-Additional .card{
      margin-bottom:2px;
...
<section class="tg-innerbanner">
   <div class="parallax-ct" style="background: url('{{$image_codever}}') no-repeat center; background-size: cover;height: 40vh;"
      data-paroller-factor="0.5" data-paroller-factor-xs="0.2" >
    
      <div class="tg-sectionspace tg-haslayout" style="padding:100px 0;">
         <div class="container">
            <div class="row">
 ...
 <?php 
            ...
            <div class="col-md-6 pb-3">
               <div class="content-title-dt">
                  ...
                  <div class="post_detail py-0" style="font-size: 0.8rem;font-style: italic;">{!!html_entity_decode($dataviewdetails['shortdescription'])!!}</div>
                  ...
                  <div class="post_detail_c">
                     ...
                     <p> <b>Duration :</b> {{$dataviewdetails['duration']}} days</p>
               ...
               <div class="row">
                  <div class="col-md-2 p-0 mb-3">
                     <ul class="nav nav-pills flex-column">
                        <li class="nav-item">
                           <a class="nav-link active" id="pill-H" data-toggle="pill" aria-controls="tab-H" href="#tab-H">Highlights</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" id="pill-A" data-toggle="pill" aria-controls="tab-B"  href="#tab-A">Itinerary</a>
                        </li>
                      <!--  <li class="nav-item">
                          <a class="nav-link" id="pill-Additional" data-toggle="pill" aria-controls="tab-Additional" href="#tab-Additional">Additional Information</a>
                       </li> -->
                        <li class="nav-item">
                  ...
                  <div id="tab-content" class="col-md-10 tab-content">
                        <div id="tab-H" class="tab-pane fade show active" role="tabpanel" aria-labelledby="pill-H">
                            
                            <?php echo htmlspecialchars_decode($dataviewdetails['highlight']); ?>&nbsp
                         </div>
                        <div id="tab-A" class="tab-pane fade" role="tabpanel" aria-labelledby="pill-A">
                            <div class="clearfix">
                     ...
                     <div id="tab-B" class="tab-pane fade" role="tabpanel" aria-labelledby="pill-B">
                        <?php if(!empty($dataviewdetails['mapscruise'])){ ?>
                                  <img src="https://b2b.tweetworldtravel.com.au/{{ $dataviewdetails['mapscruise'] }}" alt="{{$dataviewdetails['title']}}" style="height: auto;width:100%">
                                  <?php
                                }else{
                                  ?>
                            <div style="width: 100%">
                     ...
                     <div id="tab-D" class="tab-pane fade" role="tabpanel" aria-labelledby="pill-D">
                        ...
                        <div id="tab-Additional" class="tab-pane fade" role="tabpanel" aria-labelledby="pill-Additional">

                          <?php if(!empty($dataviewdetails['addnotemaster'])){?>
                            <div id="accordion">                     
                              <?php 
                                $old_iaddnotenew1 = json_decode($dataviewdetails['addnotemaster'],TRUE);
                                  foreach ($old_iaddnotenew1 as $keyold_iaddnotenew1 => $valueold_iaddnotenew1) {
                                    if(!empty(key($valueold_iaddnotenew1))){
                                                
                                          ?>
                                <div class="card">
                                <div class="card-header" id="headingOnemater<?php echo $keyold_iaddnotenew1?>">
                                          <button class="bg-white d-flex align-items-center btn btn-link btn-block" data-toggle="collapse" data-target="#collapseOnemater<?php echo $keyold_iaddnotenew1?>" aria-expanded="false" aria-controls="collapseOne<?php echo $keyold_iaddnotenew1?>">
                                              <?php echo key($valueold_iaddnotenew1); ?>
                                              <span class="fa-icon-accordion fa-stack fa-sm ml-auto">
                                                  <i class="fas fa-circle fa-stack-2x mauxanh"></i>
                                                  <i class="fas fa-plus fa-stack-1x fa-inverse"></i>
                                              </span>
                                          </button>                            
                                </div>
                            
                                <div id="collapseOnemater<?php echo $keyold_iaddnotenew1?>" class="collapse <?php //echo ($keyold_iaddnotenew == 1)?'show':'' ?>" aria-labelledby="headingOnemater<?php echo $keyold_iaddnotenew1?>" data-parent="#accordion">
                                  <div class="card-body">
                                    <?php echo nl2br($valueold_iaddnotenew1[key($valueold_iaddnotenew1)]); ?>
                                  </div>
                                </div>
                              </div>
                              <?php }?>
                      ...
                      <?php //echo htmlspecialchars_decode($dataviewdetails['terms']); 
                       ...
                       // echo htmlspecialchars_decode(json_decode($term));
                      ?>

                        <div id="term_post_add" class="term_post_add container bg-white px-3 pb-3 shadow rounded">
                        ...
                        // dd($dataviewdetails);
                         // echo htmlspecialchars_decode($dataviewdetails['terms']);
                          ...
                          <div id="readmore-btn-term">View More</div>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/enquireForm') }}">
                        {{ csrf_field() }}
...
$(document).ready(function() {
							$("#readmore-btn-term").click(function() {
								var elem = $("#readmore-btn-term").text();
								if (elem == "View More") {


							$("#readmore-btn-term").text("View Less");
              $("#term_post_add").slideDown("slow");
					//	$("#term_post_add").;
								} else {


								$("#readmore-btn-term").text("View More");
               // $("#term_post_add").slideUp("slow");
					//			$("#term_post_add").css("height","395px");
								}
                $("#term_post_add").toggleClass("term_post_add");
							});
              });
